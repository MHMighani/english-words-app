...
const orm = {
    ...
    insertOne: function(word_name,word_meaning,full_english_meaning,cb){  
        console.log(full_english_meaning);
         
        const sqlQuery1 = `insert into all_words(english_word,meaning,full_english_meaning) values('${word_name}','${word_meaning}','${full_english_meaning}')`;
